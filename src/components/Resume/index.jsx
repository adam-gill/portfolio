...
// assets
import ProfilePic from "../../assets/Images/Adam Gill 3.jpg"
        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Adam Gill"} />
              </h2>
              <h4>
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                ...
                <a href="https://www.linkedin.com/in/adam-gill-614346264/" target="_blank" rel="noreferrer">
                  <Icon img={linkedinIcon} />
                </a>
                <a href="./Adam_Gill_Resume_2024.pdf" target="_blank">
                  <Icon img={fileIcon} />
                </a>
              </motion.div>
            </div>
        ...
        <div className="resume--grid--experience">
          <div className="resume--grid--experience--head">
            <p className="theme--detail">
              <ScrambleText delay={0}>A highly motivated software engineer prepared to utilize exceptional software, problem-solving and communication skills to further my programming passion as a software engineer.</ScrambleText>
            </p>
