      ...
      <div className="techStackSec--head">
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 1 }} onAnimationComplete={() => handleComplete()} className="techStackSec--head--detail">
          <p className="theme--detail">
            <ScrambleText delay={1}>Discover the main programming languages I use everyday to build exceptional projects and products: JavaScript, Python, Java, React.js, HTML/CSS, mySQL, Firebase, Tailwind CSS, and more.</ScrambleText>
          </p>
        </motion.div>
      </div>
