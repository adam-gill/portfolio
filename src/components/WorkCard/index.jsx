    ...
    <div ref={ref} className="workCard">
      <div className="workCard--head">
        <h3>
          ...
          <a className="website__link" href={item.url} target="_blank"><IoIosLink size={24}/></a>
          <a className="website__link" href={item.url2} target="_blank"><FaGithub size={24}></FaGithub></a>
        </h3>
        <h3>
      ...
      <div className="workCard--body">
        <motion.span initial="hidden" animate={controls} variants={opacityVariants} transition={{ duration: 2, delay: 0.5 }} onAnimationComplete={() => handleComplete()}>
          <a href={item.url} target="_blank"><img src={item.img} alt="" className="work--img" /></a>
        </motion.span>
        <h1>
